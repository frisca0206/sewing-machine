...
class MachineController extends BaseController
{
    ...
    {
        $machines = $this->MachineModel->select('machine_list.*,brand.brand')
        ->join('brand','brand.id = machine_list.brand_id')->findAll();

        $data = [
            'title' => 'Machine List Management',
